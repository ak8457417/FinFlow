      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <ul className="nav-list">
            ...
            <NavLink to={'/chat'}>
              <li className={`nav-item ${activeItem === "users" ? "active" : ""}`} onClick={() => setActiveItem("users")}>
                <div className="nav-link">
                  ...
                  <span className="nav-label">Chatbuddy</span>
                  <ChevronRight size={16} className="submenu-arrow" />
                </div>
              </li>
            </NavLink>
            ...
            <NavLink to={'/tax'}>
              <li className={`nav-item ${activeItem === "pricing" ? "active" : ""}`} onClick={() => setActiveItem("pricing")}>
                <div className="nav-link">
                  <span className="nav-icon"><DollarSign size={18} /></span>
                  <span className="nav-label">Taxbuddy</span>
                  <ChevronRight size={16} className="submenu-arrow" />
                </div>
              </li>
            </NavLink>
